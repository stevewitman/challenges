 (ns cljs-solutions.test-graph
   [:require
    [cljs-solutions.graph :as g]
...
(deftest shortest-paths-test
  ...
  (testing "Paths of nodes should be extended for each adjacent node, if present."
    (are [paths                                       nodes
         ...
         (let [append-paths #'g/append-paths      ; Private, but can get the var.
               new-paths    (append-paths adj-fn nodes paths)
